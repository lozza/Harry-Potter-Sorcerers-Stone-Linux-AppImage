# Harry Potter and the Sorcerer's/Philosopher's Stone on Linux

**HP1 Builder** is a desktop tool that turns a supported prepackaged game ZIP into a Linux AppImage you can launch directly. Choose the ZIP, an output folder and a resolution; the tool builds the game app for you. No Bottles, Lutris, Wine/Proton installation is needed.
